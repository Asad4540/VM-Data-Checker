...
const Login = () => {
    return (
        ...
        <div className="relative flex items-center justify-center min-h-screen bg-[#080710] font-poppins">
            ...
            <form className="relative w-[550px] h-[620px] lg:w-[400px] lg:h-[520px] p-[20px_35px] bg-[rgba(255,255,255,0.13)] rounded-[10px] backdrop-blur-[10px] border-[2px] border-[rgba(255,255,255,0.1)] shadow-[0_0_40px_rgba(8,7,16,0.6)]">
                ...
                <input type="text" placeholder="Email or Phone" id="username" className="block w-full h-[50px] mt-2 p-[0_10px] bg-[rgba(255,255,255,0.07)] rounded-[3px] text-[14px] text-white placeholder-[#e5e5e5]" />
                <label htmlFor="password" className="block mt-[23px] lg:mt-[10px] text-[16px] font-medium text-white">Password</label>
                <input type="password" placeholder="Password" id="password" className="block w-full h-[50px] mt-2 p-[0_10px] bg-[rgba(255,255,255,0.07)] rounded-[3px] text-[14px] text-white placeholder-[#e5e5e5]" />
